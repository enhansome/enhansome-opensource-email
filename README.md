...
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 6,079 | 🐛 141 | 🌐 Go | 📅 2026-07-24 -  Composable all-in-one mail server - `GPLv3`, `Go`
...
* [James](https://github.com/apache/james-project) ⭐ 1,037 | 🐛 13 | 🌐 Java | 📅 2026-08-29 - James stands for Java Apache Mail Enterprise Server! - `Apache License Version 2.0`, `Java`
* [Chasquid](https://github.com/albertito/chasquid) ⭐ 977 | 🐛 9 | 🌐 Go | 📅 2026-08-30 - SMTP (email) server with a focus on simplicity, security, and ease of operation - `Ruby`
...
* [SMTPRelay](https://github.com/decke/smtprelay) ⭐ 630 | 🐛 5 | 🌐 Go | 📅 2026-08-28 -  Simple Golang SMTP relay/proxy server - `MIT`, `Go`
* [KumoMTA](https://github.com/KumoCorp/kumomta) ⭐ 526 | 🐛 89 | 🌐 Rust | 📅 2026-08-27 - The first Open-Source high-performance MTA developed from the ground-up for high-volume email sending environments. - `Rust`, `Lua`
...
* [Maildev](https://github.com/maildev/maildev) ⭐ 6,038 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-28 -  mailbox SMTP Server + Web Interface for viewing and testing emails during development.
* [SMTP4dev](https://github.com/rnwood/smtp4dev) ⭐ 3,947 | 🐛 30 | 🌐 C# | 📅 2026-08-30 - the fake smtp email server for development and testing
* [Inbucket](https://github.com/inbucket/inbucket) ⭐ 2,265 | 🐛 37 | 🌐 Go | 📅 2026-04-02 - Disposable webmail server (similar to Mailinator) with built in SMTP, POP3, RESTful servers; no DB required.
...
* [Dovecot](https://github.com/dovecot/core) ⭐ 1,245 | 🐛 13 | 🌐 C | 📅 2026-08-30 -  Dovecot mail server
* [James](https://github.com/apache/james-project) ⭐ 1,037 | 🐛 13 | 🌐 Java | 📅 2026-08-29 - James stands for Java Apache Mail Enterprise Server! - `Apache License Version 2.0`, `Java`
* [Cyrus](https://github.com/cyrusimap/cyrus-imapd) ⭐ 644 | 🐛 370 | 🌐 C | 📅 2026-08-28 - Cyrus IMAP is an email, contacts and calendar server
...
* [Docker Mailserver](https://github.com/docker-mailserver/docker-mailserver) ⭐ 18,811 | 🐛 99 | 🌐 Shell | 📅 2026-08-30 -  Production-ready fullstack but simple mail server (SMTP, IMAP, LDAP, Antispam, Antivirus, etc.) running inside a container.  - `MIT`
* [Mailinabox](https://github.com/mail-in-a-box/mailinabox) ⭐ 15,398 | 🐛 613 | 🌐 Python | 📅 2026-08-21 - Mail-in-a-Box helps individuals take back control of their email by defining a one-click, easy-to-deploy SMTP+everything else server: a mail server in a box.
* [Stalwart](https://github.com/stalwartlabs/mail-server) ⭐ 14,422 | 🐛 69 | 🌐 Rust | 📅 2026-08-30 -  Secure & Modern All-in-One Mail Server (IMAP, JMAP, POP3, SMTP) - `GNU AGPLv3` & `Stalwart Enterprise License 1.0 (SELv1) Agreement`, `Rust`
* [Mailu](https://github.com/Mailu/Mailu) ⭐ 7,478 | 🐛 125 | 🌐 Python | 📅 2026-08-21 -  Insular email distribution - mail server as Docker images
* [Mox](https://github.com/mjl-/mox) ⭐ 5,833 | 🐛 202 | 🌐 Go | 📅 2026-08-29 -  modern full-featured open source secure mail server for low-maintenance self-hosted email - `MIT`, `Go`
* [Forward Email](https://github.com/forwardemail/forwardemail.net) ⭐ 1,665 | 🐛 64 | 🌐 JavaScript | 📅 2026-08-29 - All-in-one 100% open-source mail server alternative to Gmail/Mailchimp/Sendgrid (IMAP, POP3, SMTP, CalDAV) - `BUSL-1.1` & `MPL-2.0`, `JavaScript`
...
* [Rspamd](https://github.com/rspamd/rspamd) ⭐ 2,515 | 🐛 297 | 🌐 C | 📅 2026-08-30 - Advanced spam filtering system and email processing framework.
* [Spamscope](https://github.com/SpamScope/spamscope) ⭐ 311 | 🐛 1 | 🌐 Python | 📅 2025-08-06 -  Fast Advanced Spam Analysis Tool.
* [AgentJ](https://github.com/Probesys/agentj) ⭐ 33 | 🐛 57 | 🌐 PHP | 📅 2026-08-28 -  AgentJ is a free software anti-spam solution with human authentication and admin panel - `AGPL`, `PHP`
...
* [Anonaddy](https://github.com/anonaddy/anonaddy) ⭐ 4,825 | 🐛 63 | 🌐 PHP | 📅 2026-07-30 -  Anonymous email forwarding

### SMTP Testing

* [MailHog](https://github.com/mailhog/MailHog) ⭐ 16,140 | 🐛 255 | 🌐 Go | 📅 2024-02-13 - Web and API based SMTP testing  - `MIT`, `Go`
* [MailPit](https://github.com/axllent/mailpit) ⭐ 10,230 | 🐛 0 | 🌐 Go | 📅 2026-08-29 - An email and SMTP testing tool with API for developers  - `MIT`, `Go`
...
* [Mailchecker](https://github.com/FGRibreau/mailchecker) ⭐ 1,904 | 🐛 5 | 🌐 PHP | 📅 2026-08-28 - Cross-language email validation. Backed by a database of over 55 000 throwable email domains.
...
* [python-email-validator](https://github.com/JoshData/python-email-validator) ⭐ 1,441 | 🐛 15 | 🌐 Python | 📅 2026-06-26 -  A robust email syntax and deliverability validation library for Python.  `The Unlicense`, `Python`
...
* [Mautic](https://github.com/mautic/mautic) ⭐ 10,419 | 🐛 192 | 🌐 PHP | 📅 2026-08-30 - Open Source Marketing Automation Software
* [Plunk](https://github.com/useplunk/plunk) ⭐ 5,407 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-30 - Open-Source Email Platform - `GNU Affero General Public License v3.0`, `typescript`
* [Sendportal](https://github.com/mettle/sendportal) ⭐ 2,164 | 🐛 52 | 🌐 PHP | 📅 2024-04-19 - Open-source self-hosted email marketing. Manage your own newsletters at a fraction of the cost.

### Newsletter Platform

* [Listmonk](https://github.com/knadh/listmonk) ⭐ 23,188 | 🐛 115 | 🌐 Go | 📅 2026-08-25 - High performance, self-hosted, newsletter and mailing list manager with a modern dashboard. Single binary app.
* [Mailtrain](https://github.com/Mailtrain-org/mailtrain) ⭐ 5,749 | 🐛 116 | 🌐 JavaScript | 📅 2025-10-05 -  Self hosted newsletter app
* [Keila](https://github.com/pentacent/keila) ⭐ 2,195 | 🐛 81 | 🌐 Elixir | 📅 2026-08-29 - Keila is an Open Source alternative to newsletter tools like Mailchimp or Sendinblue.
* [Notifuse](https://github.com/Notifuse/notifuse) ⭐ 2,090 | 🐛 5 | 🌐 Go | 📅 2026-08-29 - Notifuse is an open-source & modern emailing platform - `GNU Affero General Public License v3.0`, `go`, `typescript`
...
* [MJML](https://github.com/mjmlio/mjml) ⭐ 18,214 | 🐛 69 | 🌐 JavaScript | 📅 2026-08-28 - Framework to make responsive-email easy
* [Maizzle](https://github.com/maizzle/framework) ⭐ 1,602 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-30 -  HTML email development framework
...
* [PHPMailer](https://github.com/PHPMailer/PHPMailer) ⭐ 22,284 | 🐛 30 | 🌐 PHP | 📅 2026-08-20 -  The classic email sending library for PHP
...
* [Anymail](https://github.com/anymail/django-anymail/) ⭐ 1,899 | 🐛 15 | 🌐 Python | 📅 2026-08-29 - Django email backends and webhooks for multiple ESP - `BSD 3-Clause`, `Python`
...
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,474 | 🐛 15 | 🌐 Go | 📅 2026-08-17 - Easy to use, yet comprehensive library for sending mails with Go - `MIT`, `Go`
...
* [Emailens Engine](https://github.com/emailens/engine) ⭐ 11 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-30 - Lint HTML emails against 250+ CSS properties across 15 email clients: compatibility scoring, dark mode simulation, accessibility and spam checks - `MIT`, `Typescript`

## Editing

### Email Builder & Visual Editing Component

* [GrapesJS](https://github.com/artf/grapesjs) ⭐ 26,175 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-26 - Free and Open source Web Builder Framework. Next generation tool for building templates without coding
...
* [Easy Email](https://github.com/zalify/easy-email) ⭐ 2,940 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-13 -  DnD Email Editor based on React.js and MJML.
...
* [emailmd](https://github.com/unmta/emailmd) ⭐ 1,335 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-26 -  Render markdown into email-safe HTML  - `MIT`, `Typescript`
...
* [Tutanota](https://github.com/tutao/tutanota) ⭐ 7,883 | 🐛 998 | 🌐 TypeScript | 📅 2026-08-28 - Tutanota is an email service with a strong focus on security and privacy that lets you encrypt emails, contacts and calendar entries on all your devices.
* [Roundcube](https://github.com/roundcube/roundcubemail) ⭐ 7,141 | 🐛 480 | 🌐 PHP | 📅 2026-08-25 -  The Roundcube Webmail suite - `GPLv3`, `PHP`
* [Cypht](https://github.com/cypht-org/cypht) ⭐ 1,702 | 🐛 141 | 🌐 PHP | 📅 2026-08-30 -  Cypht: Lightweight Open Source webmail written in PHP and JavaScript - `GNU Lesser General Public License v2.1`, `PHP`, `Javascript`
* [Egroupware](https://github.com/EGroupware/egroupware) ⭐ 295 | 🐛 20 | 🌐 PHP | 📅 2026-08-29 - Web based groupware server written in PHP - `GPLv2`, `PHP`
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,138 | 🐛 7 | 🌐 Rust | 📅 2026-08-29 - CLI to manager email - `MIT`, `Rust`
...
* [Mailgoose](https://github.com/CERT-Polska/mailgoose) ⭐ 207 | 🐛 9 | 🌐 Python | 📅 2026-08-29 -  A web application that allows the users to check whether their SPF, DMARC and DKIM configuration is set up correctly. - `BSD 3-Clause "New" or "Revised" License`, `Python`
...
* [parsedmarc](https://github.com/domainaware/parsedmarc) ⭐ 1,289 | 🐛 5 | 🌐 Python | 📅 2026-08-29 -  A Python package and CLI for parsing aggregate and forensic DMARC reports  - `Apache License version 2.0`, `Python`
* [checkdmarc](https://github.com/domainaware/checkdmarc) ⭐ 321 | 🐛 0 | 🌐 Python | 📅 2026-08-30 -  A parser for SPF and DMARC DNS records - `Apache License version 2.0`, `Python`
...
* [DMARC Analyzer](https://github.com/dmarc-analyzer-net/DmarcAnalyzerApp) ⭐ 6 | 🐛 4 | 🌐 C# | 📅 2026-08-30 -  Self-hosted DMARC aggregate report monitoring with per-client dashboards and multi-tenant separation; also ingests MTA-STS and TLS-RPT reports  - `Apache License version 2.0`, `C#`

### Privacy

* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,955 | 🐛 256 | 🌐 Python | 📅 2026-08-25 - Protect your online identity with email alias

### Disposable emails domain list

* [disposable-email-domains](https://github.com/disposable-email-domains/disposable-email-domains) ⭐ 5,462 | 🐛 38 | 🌐 Python | 📅 2026-08-30 - a list of disposable and temporary email address domains - `Public Domain`, `Python`
...
* [disposable-email-domains (another one)](https://github.com/amieiro/disposable-email-domains) ⭐ 90 | 🐛 1 | 🌐 PHP | 📅 2026-08-30 -  Disposable email domain lists, used in disposable email services, generated every quarter of an hour, in txt and JSON format. - `MIT`, `PHP`
...
* [disposable-email-domains (another one too)](https://github.com/kslr/disposable-email-domains) ⭐ 30 | 🐛 3 | 🌐 Shell | 📅 2026-08-30 -  Anti-cheating, temporary (disposable/throwaway) email list - `MIT`, `Javascript`
* [disposable-email-domains (Verifly)](https://github.com/james-sib/disposable-email-domains) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-08-30 -  Daily-refreshed master list of \~162,000 disposable/temporary email domains, plus role-account local-parts and verified dead-MX domains, in txt and JSON. - `MIT`, `Python`

## Other

* [Imapsync](https://github.com/imapsync/imapsync) ⭐ 4,140 | 🐛 193 | 🌐 Shell | 📅 2026-07-23 -  Imapsync is an IMAP transfers tool. The purpose of imapsync is to migrate IMAP accounts or to backup IMAP accounts. IMAP is one of the three current standard protocols to access mailboxes, the two others are POP3 and HTTP with webmails, webmails are often tied to an IMAP server. Upstream website is   - `No Public License`, `Shell`
