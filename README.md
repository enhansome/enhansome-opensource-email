...
* [James](https://github.com/apache/james-project) ⭐ 1,038 | 🐛 12 | 🌐 Java | 📅 2026-08-27 - James stands for Java Apache Mail Enterprise Server! - `Apache License Version 2.0`, `Java`
...
* [SMTPRelay](https://github.com/decke/smtprelay) ⭐ 630 | 🐛 6 | 🌐 Go | 📅 2026-08-27 -  Simple Golang SMTP relay/proxy server - `MIT`, `Go`
* [KumoMTA](https://github.com/KumoCorp/kumomta) ⭐ 524 | 🐛 89 | 🌐 Rust | 📅 2026-08-25 - The first Open-Source high-performance MTA developed from the ground-up for high-volume email sending environments. - `Rust`, `Lua`
* [MailWhale](https://github.com/muety/mailwhale) ⚠️ Archived - A bring-your-own-SMTP-server mail relay with REST API and web UI
* [DragonFly](https://github.com/corecode/dma) ⭐ 263 | 🐛 45 | 🌐 C | 📅 2026-05-29 - A small MTA for home and office use - `Linux`, `UNIX`, `BSD`, `C`
...
* [Maildev](https://github.com/maildev/maildev) ⭐ 6,035 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-26 -  mailbox SMTP Server + Web Interface for viewing and testing emails during development.
* [SMTP4dev](https://github.com/rnwood/smtp4dev) ⭐ 3,947 | 🐛 30 | 🌐 C# | 📅 2026-08-25 - the fake smtp email server for development and testing
* [Inbucket](https://github.com/inbucket/inbucket) ⭐ 2,264 | 🐛 37 | 🌐 Go | 📅 2026-04-02 - Disposable webmail server (similar to Mailinator) with built in SMTP, POP3, RESTful servers; no DB required.
...
* [Dovecot](https://github.com/dovecot/core) ⭐ 1,244 | 🐛 13 | 🌐 C | 📅 2026-08-27 -  Dovecot mail server
* [James](https://github.com/apache/james-project) ⭐ 1,038 | 🐛 12 | 🌐 Java | 📅 2026-08-27 - James stands for Java Apache Mail Enterprise Server! - `Apache License Version 2.0`, `Java`
* [Cyrus](https://github.com/cyrusimap/cyrus-imapd) ⭐ 643 | 🐛 354 | 🌐 C | 📅 2026-08-27 - Cyrus IMAP is an email, contacts and calendar server
...
* [Docker Mailserver](https://github.com/docker-mailserver/docker-mailserver) ⭐ 18,806 | 🐛 109 | 🌐 Shell | 📅 2026-08-24 -  Production-ready fullstack but simple mail server (SMTP, IMAP, LDAP, Antispam, Antivirus, etc.) running inside a container.  - `MIT`
...
* [Stalwart](https://github.com/stalwartlabs/mail-server) ⭐ 14,368 | 🐛 73 | 🌐 Rust | 📅 2026-08-27 -  Secure & Modern All-in-One Mail Server (IMAP, JMAP, POP3, SMTP) - `GNU AGPLv3` & `Stalwart Enterprise License 1.0 (SELv1) Agreement`, `Rust`
* [Mailu](https://github.com/Mailu/Mailu) ⭐ 7,474 | 🐛 124 | 🌐 Python | 📅 2026-08-21 -  Insular email distribution - mail server as Docker images
* [Mox](https://github.com/mjl-/mox) ⭐ 5,828 | 🐛 200 | 🌐 Go | 📅 2026-08-23 -  modern full-featured open source secure mail server for low-maintenance self-hosted email - `MIT`, `Go`
...
* [Zimbra Open Source Edition](https://github.com/Zimbra/zm-build) ⭐ 244 | 🐛 14 | 🌐 Perl | 📅 2026-08-26 - A full featured email service.
...
* [Rspamd](https://github.com/rspamd/rspamd) ⭐ 2,514 | 🐛 293 | 🌐 C | 📅 2026-08-27 - Advanced spam filtering system and email processing framework.
* [Spamscope](https://github.com/SpamScope/spamscope) ⭐ 311 | 🐛 1 | 🌐 Python | 📅 2025-08-06 -  Fast Advanced Spam Analysis Tool.
* [AgentJ](https://github.com/Probesys/agentj) ⭐ 33 | 🐛 62 | 🌐 PHP | 📅 2026-08-27 -  AgentJ is a free software anti-spam solution with human authentication and admin panel - `AGPL`, `PHP`
...
* [MailPit](https://github.com/axllent/mailpit) ⭐ 10,211 | 🐛 0 | 🌐 Go | 📅 2026-08-21 - An email and SMTP testing tool with API for developers  - `MIT`, `Go`
...
* [Mailchecker](https://github.com/FGRibreau/mailchecker) ⭐ 1,905 | 🐛 5 | 🌐 PHP | 📅 2026-08-26 - Cross-language email validation. Backed by a database of over 55 000 throwable email domains.
...
* [python-email-validator](https://github.com/JoshData/python-email-validator) ⭐ 1,440 | 🐛 15 | 🌐 Python | 📅 2026-06-26 -  A robust email syntax and deliverability validation library for Python.  `The Unlicense`, `Python`
...
* [Mautic](https://github.com/mautic/mautic) ⭐ 10,399 | 🐛 190 | 🌐 PHP | 📅 2026-08-26 - Open Source Marketing Automation Software
* [Plunk](https://github.com/useplunk/plunk) ⭐ 5,398 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-24 - Open-Source Email Platform - `GNU Affero General Public License v3.0`, `typescript`
...
* [Listmonk](https://github.com/knadh/listmonk) ⭐ 23,144 | 🐛 111 | 🌐 Go | 📅 2026-08-25 - High performance, self-hosted, newsletter and mailing list manager with a modern dashboard. Single binary app.
...
* [Notifuse](https://github.com/Notifuse/notifuse) ⭐ 2,078 | 🐛 7 | 🌐 Go | 📅 2026-08-26 - Notifuse is an open-source & modern emailing platform - `GNU Affero General Public License v3.0`, `go`, `typescript`
...
* [PHPMailer](https://github.com/PHPMailer/PHPMailer) ⭐ 22,282 | 🐛 30 | 🌐 PHP | 📅 2026-08-20 -  The classic email sending library for PHP
...
* [go-smtp](https://github.com/emersion/go-smtp) ⭐ 2,042 | 🐛 32 | 🌐 Go | 📅 2026-08-18 - An SMTP client & server library written in Go - `MIT`, `Go`
...
* [Anymail](https://github.com/anymail/django-anymail/) ⭐ 1,898 | 🐛 16 | 🌐 Python | 📅 2026-07-30 - Django email backends and webhooks for multiple ESP - `BSD 3-Clause`, `Python`
* [Swoosh](https://github.com/swoosh/swoosh) ⭐ 1,524 | 🐛 16 | 🌐 Elixir | 📅 2026-08-24 -  Compose, deliver and test your emails easily in Elixir - `MIT`, `Elixir`
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,472 | 🐛 15 | 🌐 Go | 📅 2026-08-17 - Easy to use, yet comprehensive library for sending mails with Go - `MIT`, `Go`
...
* [Emailens Engine](https://github.com/emailens/engine) ⭐ 11 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-26 - Lint HTML emails against 250+ CSS properties across 15 email clients: compatibility scoring, dark mode simulation, accessibility and spam checks - `MIT`, `Typescript`
...
* [React Email Editor](https://github.com/unlayer/react-email-editor) ⭐ 5,211 | 🐛 242 | 🌐 TypeScript | 📅 2026-08-26 -  Drag-n-Drop Email Editor Component for React.js
...
* [Easy Email](https://github.com/zalify/easy-email) ⭐ 2,919 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-13 -  DnD Email Editor based on React.js and MJML.
* [Drag-and-Drop-Email-Designer](https://github.com/SendWithSES/Drag-and-Drop-Email-Designer) ⭐ 2,303 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-08 - Drag and drop HTML email designer - `MIT`, `Typescript`
...
* [Tutanota](https://github.com/tutao/tutanota) ⭐ 7,876 | 🐛 989 | 🌐 TypeScript | 📅 2026-08-27 - Tutanota is an email service with a strong focus on security and privacy that lets you encrypt emails, contacts and calendar entries on all your devices.
* [Roundcube](https://github.com/roundcube/roundcubemail) ⭐ 7,133 | 🐛 481 | 🌐 PHP | 📅 2026-08-25 -  The Roundcube Webmail suite - `GPLv3`, `PHP`
...
* [Egroupware](https://github.com/EGroupware/egroupware) ⭐ 295 | 🐛 20 | 🌐 PHP | 📅 2026-08-27 - Web based groupware server written in PHP - `GPLv2`, `PHP`
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,115 | 🐛 6 | 🌐 Rust | 📅 2026-08-25 - CLI to manager email - `MIT`, `Rust`
...
* [Mailgoose](https://github.com/CERT-Polska/mailgoose) ⭐ 207 | 🐛 10 | 🌐 Python | 📅 2026-08-27 -  A web application that allows the users to check whether their SPF, DMARC and DKIM configuration is set up correctly. - `BSD 3-Clause "New" or "Revised" License`, `Python`
...
* [parsedmarc](https://github.com/domainaware/parsedmarc) ⭐ 1,287 | 🐛 5 | 🌐 Python | 📅 2026-08-24 -  A Python package and CLI for parsing aggregate and forensic DMARC reports  - `Apache License version 2.0`, `Python`
...
* [DMARC Analyzer](https://github.com/dmarc-analyzer-net/DmarcAnalyzerApp) ⭐ 6 | 🐛 1 | 🌐 C# | 📅 2026-08-27 -  Self-hosted DMARC aggregate report monitoring with per-client dashboards and multi-tenant separation; also ingests MTA-STS and TLS-RPT reports  - `Apache License version 2.0`, `C#`
...
* [disposable-email-domains](https://github.com/disposable-email-domains/disposable-email-domains) ⭐ 5,454 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - a list of disposable and temporary email address domains - `Public Domain`, `Python`
* [disposable](https://github.com/disposable/disposable) ⭐ 1,439 | 🐛 63 | 🌐 Python | 📅 2026-08-09 -  A list of disposable/temporary email address domains - `MIT`, `Python`
...
* [disposable-email-domains (another one)](https://github.com/amieiro/disposable-email-domains) ⭐ 90 | 🐛 1 | 🌐 PHP | 📅 2026-08-27 -  Disposable email domain lists, used in disposable email services, generated every quarter of an hour, in txt and JSON format. - `MIT`, `PHP`
...
* [disposable-email-domains (another one too)](https://github.com/kslr/disposable-email-domains) ⭐ 30 | 🐛 3 | 🌐 Shell | 📅 2026-08-27 -  Anti-cheating, temporary (disposable/throwaway) email list - `MIT`, `Javascript`
...
* [Imapsync](https://github.com/imapsync/imapsync) ⭐ 4,131 | 🐛 192 | 🌐 Shell | 📅 2026-07-23 -  Imapsync is an IMAP transfers tool. The purpose of imapsync is to migrate IMAP accounts or to backup IMAP accounts. IMAP is one of the three current standard protocols to access mailboxes, the two others are POP3 and HTTP with webmails, webmails are often tied to an IMAP server. Upstream website is   - `No Public License`, `Shell`
