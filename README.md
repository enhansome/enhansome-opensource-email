...
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 6,067 | 🐛 140 | 🌐 Go | 📅 2026-07-24 -  Composable all-in-one mail server - `GPLv3`, `Go`
...
* [James](https://github.com/apache/james-project) ⭐ 1,037 | 🐛 16 | 🌐 Java | 📅 2026-08-17 - James stands for Java Apache Mail Enterprise Server! - `Apache License Version 2.0`, `Java`
...
* [SMTPRelay](https://github.com/decke/smtprelay) ⭐ 630 | 🐛 12 | 🌐 Go | 📅 2026-08-17 -  Simple Golang SMTP relay/proxy server - `MIT`, `Go`
* [KumoMTA](https://github.com/KumoCorp/kumomta) ⭐ 518 | 🐛 87 | 🌐 Rust | 📅 2026-08-17 - The first Open-Source high-performance MTA developed from the ground-up for high-volume email sending environments. - `Rust`, `Lua`
...
* [Maildev](https://github.com/maildev/maildev) ⭐ 5,991 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-17 -  mailbox SMTP Server + Web Interface for viewing and testing emails during development.
* [SMTP4dev](https://github.com/rnwood/smtp4dev) ⭐ 3,942 | 🐛 29 | 🌐 C# | 📅 2026-08-13 - the fake smtp email server for development and testing
* [Inbucket](https://github.com/inbucket/inbucket) ⭐ 2,244 | 🐛 37 | 🌐 Go | 📅 2026-04-02 - Disposable webmail server (similar to Mailinator) with built in SMTP, POP3, RESTful servers; no DB required.
* [Opentrashmail](https://github.com/HaschekSolutions/opentrashmail) ⭐ 921 | 🐛 15 | 🌐 PHP | 📅 2025-08-28 - Selfhosted trashmail solution - Receive Emails via Web UI, JSON API and RSS feed
...
* [Dovecot](https://github.com/dovecot/core) ⭐ 1,238 | 🐛 15 | 🌐 C | 📅 2026-08-17 -  Dovecot mail server
* [James](https://github.com/apache/james-project) ⭐ 1,037 | 🐛 16 | 🌐 Java | 📅 2026-08-17 - James stands for Java Apache Mail Enterprise Server! - `Apache License Version 2.0`, `Java`
* [Cyrus](https://github.com/cyrusimap/cyrus-imapd) ⭐ 642 | 🐛 357 | 🌐 C | 📅 2026-08-17 - Cyrus IMAP is an email, contacts and calendar server
...
* [JMAP](https://github.com/jmapio/jmap) ⭐ 1,362 | 🐛 13 | 🌐 Makefile | 📅 2026-07-17 -  JSON Meta Application Protocol Specification (JMAP) Specification
* [James](https://github.com/apache/james-project) ⭐ 1,037 | 🐛 16 | 🌐 Java | 📅 2026-08-17 - James stands for Java Apache Mail Enterprise Server! - `Apache License Version 2.0`, `Java`
...
* [Docker Mailserver](https://github.com/docker-mailserver/docker-mailserver) ⭐ 18,747 | 🐛 111 | 🌐 Shell | 📅 2026-08-03 -  Production-ready fullstack but simple mail server (SMTP, IMAP, LDAP, Antispam, Antivirus, etc.) running inside a container.  - `MIT`
* [Mailinabox](https://github.com/mail-in-a-box/mailinabox) ⭐ 15,389 | 🐛 613 | 🌐 Python | 📅 2026-05-24 - Mail-in-a-Box helps individuals take back control of their email by defining a one-click, easy-to-deploy SMTP+everything else server: a mail server in a box.
* [Stalwart](https://github.com/stalwartlabs/mail-server) ⭐ 14,220 | 🐛 73 | 🌐 Rust | 📅 2026-08-17 -  Secure & Modern All-in-One Mail Server (IMAP, JMAP, POP3, SMTP) - `GNU AGPLv3` & `Stalwart Enterprise License 1.0 (SELv1) Agreement`, `Rust`
* [Mailu](https://github.com/Mailu/Mailu) ⭐ 7,454 | 🐛 124 | 🌐 Python | 📅 2026-08-17 -  Insular email distribution - mail server as Docker images
* [Mox](https://github.com/mjl-/mox) ⭐ 5,810 | 🐛 200 | 🌐 Go | 📅 2026-08-16 -  modern full-featured open source secure mail server for low-maintenance self-hosted email - `MIT`, `Go`
* [Forward Email](https://github.com/forwardemail/forwardemail.net) ⭐ 1,660 | 🐛 61 | 🌐 JavaScript | 📅 2026-08-16 - All-in-one 100% open-source mail server alternative to Gmail/Mailchimp/Sendgrid (IMAP, POP3, SMTP, CalDAV) - `BUSL-1.1` & `MPL-2.0`, `JavaScript`
* [Zimbra Open Source Edition](https://github.com/Zimbra/zm-build) ⭐ 242 | 🐛 13 | 🌐 Perl | 📅 2026-08-17 - A full featured email service.
...
* [Erooster Email Server](https://github.com/erooster-mail/erooster) ⭐ 61 | 🐛 30 | 🌐 Rust | 📅 2026-08-10 -  A mail suite written in rust meant to be easy to use.
...
* [Rspamd](https://github.com/rspamd/rspamd) ⭐ 2,512 | 🐛 291 | 🌐 C | 📅 2026-08-17 - Advanced spam filtering system and email processing framework.
* [Spamscope](https://github.com/SpamScope/spamscope) ⭐ 311 | 🐛 1 | 🌐 Python | 📅 2025-08-06 -  Fast Advanced Spam Analysis Tool.
* [AgentJ](https://github.com/Probesys/agentj) ⭐ 33 | 🐛 63 | 🌐 PHP | 📅 2026-08-14 -  AgentJ is a free software anti-spam solution with human authentication and admin panel - `AGPL`, `PHP`
...
* [Anonaddy](https://github.com/anonaddy/anonaddy) ⭐ 4,804 | 🐛 62 | 🌐 PHP | 📅 2026-07-30 -  Anonymous email forwarding

### SMTP Testing

* [MailHog](https://github.com/mailhog/MailHog) ⭐ 16,122 | 🐛 255 | 🌐 Go | 📅 2024-02-13 - Web and API based SMTP testing  - `MIT`, `Go`
* [MailPit](https://github.com/axllent/mailpit) ⭐ 10,129 | 🐛 0 | 🌐 Go | 📅 2026-08-16 - An email and SMTP testing tool with API for developers  - `MIT`, `Go`
...
* [Mail-Parser](https://github.com/SpamScope/mail-parser) ⭐ 455 | 🐛 2 | 🌐 Python | 📅 2026-08-12 -  A tool that parses emails by enhancing the Python standard library, extracting all details into a comprehensive object. `Apache License 2.0`, `Python`
...
* [Email-Verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,596 | 🐛 26 | 🌐 Go | 📅 2026-08-17 - A Go library for email verification without sending any emails.  - `MIT`, `Go`
* [python-email-validator](https://github.com/JoshData/python-email-validator) ⭐ 1,432 | 🐛 15 | 🌐 Python | 📅 2026-06-26 -  A robust email syntax and deliverability validation library for Python.  `The Unlicense`, `Python`
* [Truemail](https://github.com/truemail-rb/truemail) ⭐ 1,270 | 🐛 2 | 🌐 Ruby | 📅 2024-04-23 - Configurable framework agnostic plain Ruby email validator/verifier. Verify email via Regex, DNS, SMTP and even more. Be sure that email address valid and exists.  - `MIT`, `Ruby`
...
* [Google Postmaster Datas](https://github.com/Mindbaz/python-gpostmaster-domains-datas) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Downloads and flattends datas from Google Postmaster Tools (GPT)
...
* [Mautic](https://github.com/mautic/mautic) ⭐ 10,361 | 🐛 192 | 🌐 PHP | 📅 2026-08-17 - Open Source Marketing Automation Software
* [Plunk](https://github.com/useplunk/plunk) ⭐ 5,370 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-17 - Open-Source Email Platform - `GNU Affero General Public License v3.0`, `typescript`
* [Sendportal](https://github.com/mettle/sendportal) ⭐ 2,158 | 🐛 52 | 🌐 PHP | 📅 2024-04-19 - Open-source self-hosted email marketing. Manage your own newsletters at a fraction of the cost.

### Newsletter Platform

* [Listmonk](https://github.com/knadh/listmonk) ⭐ 22,945 | 🐛 105 | 🌐 Go | 📅 2026-08-17 - High performance, self-hosted, newsletter and mailing list manager with a modern dashboard. Single binary app.
* [Mailtrain](https://github.com/Mailtrain-org/mailtrain) ⭐ 5,745 | 🐛 115 | 🌐 JavaScript | 📅 2025-10-05 -  Self hosted newsletter app
* [Keila](https://github.com/pentacent/keila) ⭐ 2,187 | 🐛 76 | 🌐 Elixir | 📅 2026-08-01 - Keila is an Open Source alternative to newsletter tools like Mailchimp or Sendinblue.
* [Notifuse](https://github.com/Notifuse/notifuse) ⭐ 2,046 | 🐛 3 | 🌐 Go | 📅 2026-08-17 - Notifuse is an open-source & modern emailing platform - `GNU Affero General Public License v3.0`, `go`, `typescript`
* [phplist3](https://github.com/phpList/phplist3) ⭐ 869 | 🐛 90 | 🌐 PHP | 📅 2026-08-16 - Fully functional Open Source email marketing manager for creating, sending, integrating, and analysing email campaigns and newsletters.
...
* [MJML](https://github.com/mjmlio/mjml) ⭐ 18,201 | 🐛 68 | 🌐 JavaScript | 📅 2026-08-17 - Framework to make responsive-email easy
* [Maizzle](https://github.com/maizzle/framework) ⭐ 1,597 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-16 -  HTML email development framework
...
* [Hermes](https://github.com/matcornic/hermes) ⭐ 3,020 | 🐛 22 | 🌐 Go | 📅 2025-04-04 -  Golang package that generates clean, responsive HTML e-mails for sending transactional mail
* [Maud](https://github.com/lambda-fairy/maud) ⭐ 2,623 | 🐛 64 | 🌐 Rust | 📅 2026-05-25 - Compile-time HTML templates for Rust  - `MIT`, `Apache License`, `Rust`
...
* [PHPMailer](https://github.com/PHPMailer/PHPMailer) ⭐ 22,281 | 🐛 30 | 🌐 PHP | 📅 2026-08-17 -  The classic email sending library for PHP
* [MailKit](https://github.com/jstedfast/MailKit) ⭐ 6,840 | 🐛 9 | 🌐 C# | 📅 2026-08-17 -  A cross-platform .NET library for IMAP, POP3, and SMTP.
* [lettre](https://github.com/lettre/lettre) ⭐ 2,252 | 🐛 81 | 🌐 Rust | 📅 2026-08-03 - a mailer library for Rust - `MIT`, `Rust`
* [go-smtp](https://github.com/emersion/go-smtp) ⭐ 2,039 | 🐛 33 | 🌐 Go | 📅 2026-08-13 - An SMTP client & server library written in Go - `MIT`, `Go`
...
* [Swoosh](https://github.com/swoosh/swoosh) ⭐ 1,522 | 🐛 13 | 🌐 Elixir | 📅 2026-08-17 -  Compose, deliver and test your emails easily in Elixir - `MIT`, `Elixir`
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,467 | 🐛 15 | 🌐 Go | 📅 2026-08-17 - Easy to use, yet comprehensive library for sending mails with Go - `MIT`, `Go`
* [Nette Mail](https://github.com/nette/mail) ⭐ 493 | 🐛 1 | 🌐 PHP | 📅 2026-07-28 - Handy email creation and transfer library for PHP with both text and MIME-compliant support.
...
* [React Email Editor](https://github.com/unlayer/react-email-editor) ⭐ 5,202 | 🐛 240 | 🌐 TypeScript | 📅 2026-08-12 -  Drag-n-Drop Email Editor Component for React.js
* [maily.to](https://github.com/arikchakma/maily.to) ⭐ 3,924 | 🐛 5 | 🌐 TypeScript | 📅 2026-07-21 -  Craft beautiful emails effortlessly with Maily, the powerful email editor that ensures impeccable communication across all major clients. - `MIT`, `Typescript`
* [Easy Email](https://github.com/zalify/easy-email) ⭐ 2,860 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-13 -  DnD Email Editor based on React.js and MJML.
* [Drag-and-Drop-Email-Designer](https://github.com/SendWithSES/Drag-and-Drop-Email-Designer) ⭐ 2,272 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-08 - Drag and drop HTML email designer - `MIT`, `Typescript`
* [Mosaico](https://github.com/voidlabs/mosaico) ⭐ 1,781 | 🐛 22 | 🌐 HTML | 📅 2025-08-22 - Responsive Email Template Editor
* [email-builder-js](https://github.com/usewaypoint/email-builder-js) ⭐ 1,734 | 🐛 51 | 🌐 TypeScript | 📅 2026-02-09 -  A free and open-source block-based email template builder - `MIT`, `Typescript`
* [emailmd](https://github.com/unmta/emailmd) ⭐ 1,300 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-15 -  Render markdown into email-safe HTML  - `MIT`, `Typescript`
...
* [MySigMail Card](https://github.com/mysigmail/card) ⭐ 417 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-07 - An open source html email template builder with drag & drop editor
* [LePatron](https://github.com/Badsender-com/LePatron.email) ⭐ 90 | 🐛 27 | 🌐 JavaScript | 📅 2026-08-17 -  LePatron is an opensource email builder allowing to industrialize your email template production. Build tailor made email templates and make them available to your non-technical users.
...
* [Tutanota](https://github.com/tutao/tutanota) ⭐ 7,858 | 🐛 970 | 🌐 TypeScript | 📅 2026-08-17 - Tutanota is an email service with a strong focus on security and privacy that lets you encrypt emails, contacts and calendar entries on all your devices.
* [Roundcube](https://github.com/roundcube/roundcubemail) ⭐ 7,124 | 🐛 480 | 🌐 PHP | 📅 2026-08-16 -  The Roundcube Webmail suite - `GPLv3`, `PHP`
* [Cypht](https://github.com/cypht-org/cypht) ⭐ 1,680 | 🐛 141 | 🌐 PHP | 📅 2026-08-15 -  Cypht: Lightweight Open Source webmail written in PHP and JavaScript - `GNU Lesser General Public License v2.1`, `PHP`, `Javascript`
* [Egroupware](https://github.com/EGroupware/egroupware) ⭐ 295 | 🐛 19 | 🌐 PHP | 📅 2026-08-17 - Web based groupware server written in PHP - `GPLv2`, `PHP`
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,035 | 🐛 6 | 🌐 Rust | 📅 2026-08-16 - CLI to manager email - `MIT`, `Rust`
...
* [parsedmarc](https://github.com/domainaware/parsedmarc) ⭐ 1,281 | 🐛 4 | 🌐 Python | 📅 2026-08-17 -  A Python package and CLI for parsing aggregate and forensic DMARC reports  - `Apache License version 2.0`, `Python`
* [checkdmarc](https://github.com/domainaware/checkdmarc) ⭐ 318 | 🐛 0 | 🌐 Python | 📅 2026-08-16 -  A parser for SPF and DMARC DNS records - `Apache License version 2.0`, `Python`
...
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,921 | 🐛 253 | 🌐 Python | 📅 2026-08-17 - Protect your online identity with email alias

### Disposable emails domain list

* [disposable-email-domains](https://github.com/disposable-email-domains/disposable-email-domains) ⭐ 5,428 | 🐛 37 | 🌐 Python | 📅 2026-08-17 - a list of disposable and temporary email address domains - `Public Domain`, `Python`
* [disposable](https://github.com/disposable/disposable) ⭐ 1,429 | 🐛 63 | 🌐 Python | 📅 2026-08-09 -  A list of disposable/temporary email address domains - `MIT`, `Python`
...
* [disposable-email-domains (another one)](https://github.com/amieiro/disposable-email-domains) ⭐ 90 | 🐛 0 | 🌐 PHP | 📅 2026-08-17 -  Disposable email domain lists, used in disposable email services, generated every quarter of an hour, in txt and JSON format. - `MIT`, `PHP`
...
* [disposable-email-domains (another one too)](https://github.com/kslr/disposable-email-domains) ⭐ 30 | 🐛 3 | 🌐 Shell | 📅 2026-08-17 -  Anti-cheating, temporary (disposable/throwaway) email list - `MIT`, `Javascript`
* [disposable-email-domains (Verifly)](https://github.com/james-sib/disposable-email-domains) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-08-17 -  Daily-refreshed master list of \~162,000 disposable/temporary email domains, plus role-account local-parts and verified dead-MX domains, in txt and JSON. - `MIT`, `Python`

## Other

* [Imapsync](https://github.com/imapsync/imapsync) ⭐ 4,124 | 🐛 191 | 🌐 Shell | 📅 2026-07-23 -  Imapsync is an IMAP transfers tool. The purpose of imapsync is to migrate IMAP accounts or to backup IMAP accounts. IMAP is one of the three current standard protocols to access mailboxes, the two others are POP3 and HTTP with webmails, webmails are often tied to an IMAP server. Upstream website is   - `No Public License`, `Shell`
