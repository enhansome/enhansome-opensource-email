...
* [Postal](https://github.com/postalserver/postal) ⭐ 16,748 | 🐛 88 | 🌐 Ruby | 📅 2026-08-18 - A fully featured open source mail delivery platform for incoming & outgoing e-mail
* [Maddy](https://github.com/foxcpp/maddy) ⭐ 6,070 | 🐛 140 | 🌐 Go | 📅 2026-07-24 -  Composable all-in-one mail server - `GPLv3`, `Go`
...
* [James](https://github.com/apache/james-project) ⭐ 1,037 | 🐛 10 | 🌐 Java | 📅 2026-08-20 - James stands for Java Apache Mail Enterprise Server! - `Apache License Version 2.0`, `Java`
...
* [Maildev](https://github.com/maildev/maildev) ⭐ 5,994 | 🐛 55 | 🌐 TypeScript | 📅 2026-08-19 -  mailbox SMTP Server + Web Interface for viewing and testing emails during development.
* [SMTP4dev](https://github.com/rnwood/smtp4dev) ⭐ 3,944 | 🐛 29 | 🌐 C# | 📅 2026-08-20 - the fake smtp email server for development and testing
* [Inbucket](https://github.com/inbucket/inbucket) ⭐ 2,246 | 🐛 37 | 🌐 Go | 📅 2026-04-02 - Disposable webmail server (similar to Mailinator) with built in SMTP, POP3, RESTful servers; no DB required.
...
* [Dovecot](https://github.com/dovecot/core) ⭐ 1,239 | 🐛 17 | 🌐 C | 📅 2026-08-20 -  Dovecot mail server
* [James](https://github.com/apache/james-project) ⭐ 1,037 | 🐛 10 | 🌐 Java | 📅 2026-08-20 - James stands for Java Apache Mail Enterprise Server! - `Apache License Version 2.0`, `Java`
* [Cyrus](https://github.com/cyrusimap/cyrus-imapd) ⭐ 642 | 🐛 352 | 🌐 C | 📅 2026-08-20 - Cyrus IMAP is an email, contacts and calendar server
...
* [JMAP](https://github.com/jmapio/jmap) ⭐ 1,365 | 🐛 13 | 🌐 Makefile | 📅 2026-07-17 -  JSON Meta Application Protocol Specification (JMAP) Specification
* [James](https://github.com/apache/james-project) ⭐ 1,037 | 🐛 10 | 🌐 Java | 📅 2026-08-20 - James stands for Java Apache Mail Enterprise Server! - `Apache License Version 2.0`, `Java`
...
* [Docker Mailserver](https://github.com/docker-mailserver/docker-mailserver) ⭐ 18,766 | 🐛 105 | 🌐 Shell | 📅 2026-08-19 -  Production-ready fullstack but simple mail server (SMTP, IMAP, LDAP, Antispam, Antivirus, etc.) running inside a container.  - `MIT`
* [Mailinabox](https://github.com/mail-in-a-box/mailinabox) ⭐ 15,388 | 🐛 614 | 🌐 Python | 📅 2026-05-24 - Mail-in-a-Box helps individuals take back control of their email by defining a one-click, easy-to-deploy SMTP+everything else server: a mail server in a box.
* [Stalwart](https://github.com/stalwartlabs/mail-server) ⭐ 14,281 | 🐛 73 | 🌐 Rust | 📅 2026-08-20 -  Secure & Modern All-in-One Mail Server (IMAP, JMAP, POP3, SMTP) - `GNU AGPLv3` & `Stalwart Enterprise License 1.0 (SELv1) Agreement`, `Rust`
* [Mailu](https://github.com/Mailu/Mailu) ⭐ 7,464 | 🐛 124 | 🌐 Python | 📅 2026-08-17 -  Insular email distribution - mail server as Docker images
* [Mox](https://github.com/mjl-/mox) ⭐ 5,817 | 🐛 198 | 🌐 Go | 📅 2026-08-19 -  modern full-featured open source secure mail server for low-maintenance self-hosted email - `MIT`, `Go`
* [Forward Email](https://github.com/forwardemail/forwardemail.net) ⭐ 1,662 | 🐛 62 | 🌐 JavaScript | 📅 2026-08-16 - All-in-one 100% open-source mail server alternative to Gmail/Mailchimp/Sendgrid (IMAP, POP3, SMTP, CalDAV) - `BUSL-1.1` & `MPL-2.0`, `JavaScript`
...
* [Anonaddy](https://github.com/anonaddy/anonaddy) ⭐ 4,810 | 🐛 62 | 🌐 PHP | 📅 2026-07-30 -  Anonymous email forwarding

### SMTP Testing

* [MailHog](https://github.com/mailhog/MailHog) ⭐ 16,126 | 🐛 255 | 🌐 Go | 📅 2024-02-13 - Web and API based SMTP testing  - `MIT`, `Go`
* [MailPit](https://github.com/axllent/mailpit) ⭐ 10,164 | 🐛 0 | 🌐 Go | 📅 2026-08-16 - An email and SMTP testing tool with API for developers  - `MIT`, `Go`
...
* [MailKite Server](https://github.com/mailkite/server) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-06 - Programmable mail server for apps and AI agents: Haraka-based SMTP (MX + submission), IMAP server, SQLite backend and web console; self-hosted via Docker Compose - `AGPL-3.0`, `Nodejs`
* [MailCatcher](https://mailcatcher.me/) - Catches mail and serves it via a webui  - `MIT`, `Ruby`

### Inbound - Mail Parser

* [Mail-Parser](https://github.com/SpamScope/mail-parser) ⭐ 455 | 🐛 0 | 🌐 Python | 📅 2026-08-19 -  A tool that parses emails by enhancing the Python standard library, extracting all details into a comprehensive object. `Apache License 2.0`, `Python`
...
* [Email-Verifier](https://github.com/AfterShip/email-verifier) ⭐ 1,599 | 🐛 26 | 🌐 Go | 📅 2026-08-20 - A Go library for email verification without sending any emails.  - `MIT`, `Go`
* [python-email-validator](https://github.com/JoshData/python-email-validator) ⭐ 1,435 | 🐛 15 | 🌐 Python | 📅 2026-06-26 -  A robust email syntax and deliverability validation library for Python.  `The Unlicense`, `Python`
...
* [Mautic](https://github.com/mautic/mautic) ⭐ 10,371 | 🐛 192 | 🌐 PHP | 📅 2026-08-20 - Open Source Marketing Automation Software
* [Plunk](https://github.com/useplunk/plunk) ⭐ 5,379 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-17 - Open-Source Email Platform - `GNU Affero General Public License v3.0`, `typescript`
...
* [Listmonk](https://github.com/knadh/listmonk) ⭐ 23,016 | 🐛 107 | 🌐 Go | 📅 2026-08-19 - High performance, self-hosted, newsletter and mailing list manager with a modern dashboard. Single binary app.
* [Mailtrain](https://github.com/Mailtrain-org/mailtrain) ⭐ 5,745 | 🐛 115 | 🌐 JavaScript | 📅 2025-10-05 -  Self hosted newsletter app
* [Keila](https://github.com/pentacent/keila) ⭐ 2,190 | 🐛 77 | 🌐 Elixir | 📅 2026-08-18 - Keila is an Open Source alternative to newsletter tools like Mailchimp or Sendinblue.
* [Notifuse](https://github.com/Notifuse/notifuse) ⭐ 2,052 | 🐛 5 | 🌐 Go | 📅 2026-08-18 - Notifuse is an open-source & modern emailing platform - `GNU Affero General Public License v3.0`, `go`, `typescript`
...
* [MJML](https://github.com/mjmlio/mjml) ⭐ 18,203 | 🐛 68 | 🌐 JavaScript | 📅 2026-08-17 - Framework to make responsive-email easy
...
* [Cerberus](https://github.com/TedGoas/Cerberus) ⭐ 5,128 | 🐛 13 | 🌐 HTML | 📅 2024-07-16 -  A few simple, but solid patterns for responsive HTML email templates and newsletters. Even in Outlook and Gmail.
...
* [PHPMailer](https://github.com/PHPMailer/PHPMailer) ⭐ 22,280 | 🐛 30 | 🌐 PHP | 📅 2026-08-17 -  The classic email sending library for PHP
* [MailKit](https://github.com/jstedfast/MailKit) ⭐ 6,839 | 🐛 9 | 🌐 C# | 📅 2026-08-19 -  A cross-platform .NET library for IMAP, POP3, and SMTP.
...
* [Swoosh](https://github.com/swoosh/swoosh) ⭐ 1,523 | 🐛 14 | 🌐 Elixir | 📅 2026-08-17 -  Compose, deliver and test your emails easily in Elixir - `MIT`, `Elixir`
...
* [React Email Editor](https://github.com/unlayer/react-email-editor) ⭐ 5,206 | 🐛 241 | 🌐 TypeScript | 📅 2026-08-19 -  Drag-n-Drop Email Editor Component for React.js
...
* [Easy Email](https://github.com/zalify/easy-email) ⭐ 2,874 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-13 -  DnD Email Editor based on React.js and MJML.
...
* [email-builder-js](https://github.com/usewaypoint/email-builder-js) ⭐ 1,736 | 🐛 51 | 🌐 TypeScript | 📅 2026-02-09 -  A free and open-source block-based email template builder - `MIT`, `Typescript`
...
* [LePatron](https://github.com/Badsender-com/LePatron.email) ⭐ 90 | 🐛 30 | 🌐 JavaScript | 📅 2026-08-20 -  LePatron is an opensource email builder allowing to industrialize your email template production. Build tailor made email templates and make them available to your non-technical users.
...
* [Tutanota](https://github.com/tutao/tutanota) ⭐ 7,865 | 🐛 980 | 🌐 TypeScript | 📅 2026-08-20 - Tutanota is an email service with a strong focus on security and privacy that lets you encrypt emails, contacts and calendar entries on all your devices.
* [Roundcube](https://github.com/roundcube/roundcubemail) ⭐ 7,126 | 🐛 482 | 🌐 PHP | 📅 2026-08-16 -  The Roundcube Webmail suite - `GPLv3`, `PHP`
* [Cypht](https://github.com/cypht-org/cypht) ⭐ 1,689 | 🐛 142 | 🌐 PHP | 📅 2026-08-15 -  Cypht: Lightweight Open Source webmail written in PHP and JavaScript - `GNU Lesser General Public License v2.1`, `PHP`, `Javascript`
* [Egroupware](https://github.com/EGroupware/egroupware) ⭐ 295 | 🐛 19 | 🌐 PHP | 📅 2026-08-20 - Web based groupware server written in PHP - `GPLv2`, `PHP`
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,066 | 🐛 7 | 🌐 Rust | 📅 2026-08-16 - CLI to manager email - `MIT`, `Rust`
...
* [checkdmarc](https://github.com/domainaware/checkdmarc) ⭐ 319 | 🐛 0 | 🌐 Python | 📅 2026-08-19 -  A parser for SPF and DMARC DNS records - `Apache License version 2.0`, `Python`
...
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,936 | 🐛 253 | 🌐 Python | 📅 2026-08-17 - Protect your online identity with email alias

### Disposable emails domain list

* [disposable-email-domains](https://github.com/disposable-email-domains/disposable-email-domains) ⭐ 5,433 | 🐛 36 | 🌐 Python | 📅 2026-08-20 - a list of disposable and temporary email address domains - `Public Domain`, `Python`
...
* [disposable-email-domains (another one)](https://github.com/amieiro/disposable-email-domains) ⭐ 90 | 🐛 0 | 🌐 PHP | 📅 2026-08-20 -  Disposable email domain lists, used in disposable email services, generated every quarter of an hour, in txt and JSON format. - `MIT`, `PHP`
...
* [disposable-email-domains (another one too)](https://github.com/kslr/disposable-email-domains) ⭐ 30 | 🐛 3 | 🌐 Shell | 📅 2026-08-20 -  Anti-cheating, temporary (disposable/throwaway) email list - `MIT`, `Javascript`
* [disposable-email-domains (Verifly)](https://github.com/james-sib/disposable-email-domains) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-08-20 -  Daily-refreshed master list of \~162,000 disposable/temporary email domains, plus role-account local-parts and verified dead-MX domains, in txt and JSON. - `MIT`, `Python`
