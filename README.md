...
* [James](https://github.com/apache/james-project) ⭐ 1,038 | 🐛 13 | 🌐 Java | 📅 2026-08-28 - James stands for Java Apache Mail Enterprise Server! - `Apache License Version 2.0`, `Java`
...
* [Maildev](https://github.com/maildev/maildev) ⭐ 6,036 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-28 -  mailbox SMTP Server + Web Interface for viewing and testing emails during development.
...
* [Docker Mailserver](https://github.com/docker-mailserver/docker-mailserver) ⭐ 18,810 | 🐛 109 | 🌐 Shell | 📅 2026-08-28 -  Production-ready fullstack but simple mail server (SMTP, IMAP, LDAP, Antispam, Antivirus, etc.) running inside a container.  - `MIT`
...
* [Rspamd](https://github.com/rspamd/rspamd) ⭐ 2,515 | 🐛 300 | 🌐 C | 📅 2026-08-28 - Advanced spam filtering system and email processing framework.
...
* [Anonaddy](https://github.com/anonaddy/anonaddy) ⭐ 4,822 | 🐛 63 | 🌐 PHP | 📅 2026-07-30 -  Anonymous email forwarding
...
* [MJML](https://github.com/mjmlio/mjml) ⭐ 18,212 | 🐛 69 | 🌐 JavaScript | 📅 2026-08-28 - Framework to make responsive-email easy
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,127 | 🐛 8 | 🌐 Rust | 📅 2026-08-28 - CLI to manager email - `MIT`, `Rust`
...
* [DMARC Analyzer](https://github.com/dmarc-analyzer-net/DmarcAnalyzerApp) ⭐ 6 | 🐛 6 | 🌐 C# | 📅 2026-08-27 -  Self-hosted DMARC aggregate report monitoring with per-client dashboards and multi-tenant separation; also ingests MTA-STS and TLS-RPT reports  - `Apache License version 2.0`, `C#`
