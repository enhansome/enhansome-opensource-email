...
* [James](https://github.com/apache/james-project) ⭐ 1,038 | 🐛 13 | 🌐 Java | 📅 2026-08-29 - James stands for Java Apache Mail Enterprise Server! - `Apache License Version 2.0`, `Java`
...
* [KumoMTA](https://github.com/KumoCorp/kumomta) ⭐ 525 | 🐛 89 | 🌐 Rust | 📅 2026-08-27 - The first Open-Source high-performance MTA developed from the ground-up for high-volume email sending environments. - `Rust`, `Lua`
...
* [Maildev](https://github.com/maildev/maildev) ⭐ 6,037 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-28 -  mailbox SMTP Server + Web Interface for viewing and testing emails during development.
...
* [Dovecot](https://github.com/dovecot/core) ⭐ 1,244 | 🐛 13 | 🌐 C | 📅 2026-08-28 -  Dovecot mail server
* [James](https://github.com/apache/james-project) ⭐ 1,038 | 🐛 13 | 🌐 Java | 📅 2026-08-29 - James stands for Java Apache Mail Enterprise Server! - `Apache License Version 2.0`, `Java`
* [Cyrus](https://github.com/cyrusimap/cyrus-imapd) ⭐ 644 | 🐛 358 | 🌐 C | 📅 2026-08-28 - Cyrus IMAP is an email, contacts and calendar server
...
* [Docker Mailserver](https://github.com/docker-mailserver/docker-mailserver) ⭐ 18,813 | 🐛 103 | 🌐 Shell | 📅 2026-08-29 -  Production-ready fullstack but simple mail server (SMTP, IMAP, LDAP, Antispam, Antivirus, etc.) running inside a container.  - `MIT`
...
* [Stalwart](https://github.com/stalwartlabs/mail-server) ⭐ 14,394 | 🐛 71 | 🌐 Rust | 📅 2026-08-29 -  Secure & Modern All-in-One Mail Server (IMAP, JMAP, POP3, SMTP) - `GNU AGPLv3` & `Stalwart Enterprise License 1.0 (SELv1) Agreement`, `Rust`
* [Mailu](https://github.com/Mailu/Mailu) ⭐ 7,478 | 🐛 125 | 🌐 Python | 📅 2026-08-21 -  Insular email distribution - mail server as Docker images
* [Mox](https://github.com/mjl-/mox) ⭐ 5,832 | 🐛 201 | 🌐 Go | 📅 2026-08-29 -  modern full-featured open source secure mail server for low-maintenance self-hosted email - `MIT`, `Go`
* [Forward Email](https://github.com/forwardemail/forwardemail.net) ⭐ 1,663 | 🐛 64 | 🌐 JavaScript | 📅 2026-08-29 - All-in-one 100% open-source mail server alternative to Gmail/Mailchimp/Sendgrid (IMAP, POP3, SMTP, CalDAV) - `BUSL-1.1` & `MPL-2.0`, `JavaScript`
...
* [Rspamd](https://github.com/rspamd/rspamd) ⭐ 2,515 | 🐛 298 | 🌐 C | 📅 2026-08-29 - Advanced spam filtering system and email processing framework.
...
* [MailPit](https://github.com/axllent/mailpit) ⭐ 10,229 | 🐛 0 | 🌐 Go | 📅 2026-08-29 - An email and SMTP testing tool with API for developers  - `MIT`, `Go`
...
* [Mailchecker](https://github.com/FGRibreau/mailchecker) ⭐ 1,904 | 🐛 4 | 🌐 PHP | 📅 2026-08-28 - Cross-language email validation. Backed by a database of over 55 000 throwable email domains.
...
* [Mautic](https://github.com/mautic/mautic) ⭐ 10,415 | 🐛 190 | 🌐 PHP | 📅 2026-08-28 - Open Source Marketing Automation Software
* [Plunk](https://github.com/useplunk/plunk) ⭐ 5,407 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-24 - Open-Source Email Platform - `GNU Affero General Public License v3.0`, `typescript`
* [Sendportal](https://github.com/mettle/sendportal) ⭐ 2,162 | 🐛 52 | 🌐 PHP | 📅 2024-04-19 - Open-source self-hosted email marketing. Manage your own newsletters at a fraction of the cost.

### Newsletter Platform

* [Listmonk](https://github.com/knadh/listmonk) ⭐ 23,172 | 🐛 114 | 🌐 Go | 📅 2026-08-25 - High performance, self-hosted, newsletter and mailing list manager with a modern dashboard. Single binary app.
* [Mailtrain](https://github.com/Mailtrain-org/mailtrain) ⭐ 5,749 | 🐛 116 | 🌐 JavaScript | 📅 2025-10-05 -  Self hosted newsletter app
* [Keila](https://github.com/pentacent/keila) ⭐ 2,194 | 🐛 81 | 🌐 Elixir | 📅 2026-08-29 - Keila is an Open Source alternative to newsletter tools like Mailchimp or Sendinblue.
* [Notifuse](https://github.com/Notifuse/notifuse) ⭐ 2,088 | 🐛 5 | 🌐 Go | 📅 2026-08-29 - Notifuse is an open-source & modern emailing platform - `GNU Affero General Public License v3.0`, `go`, `typescript`
...
* [Maizzle](https://github.com/maizzle/framework) ⭐ 1,602 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-24 -  HTML email development framework
...
* [Anymail](https://github.com/anymail/django-anymail/) ⭐ 1,899 | 🐛 16 | 🌐 Python | 📅 2026-07-30 - Django email backends and webhooks for multiple ESP - `BSD 3-Clause`, `Python`
...
* [go-mail](https://github.com/wneessen/go-mail) ⭐ 1,473 | 🐛 15 | 🌐 Go | 📅 2026-08-17 - Easy to use, yet comprehensive library for sending mails with Go - `MIT`, `Go`
...
* [Can I email](https://github.com/hteumeuleu/caniemail) ⭐ 939 | 🐛 96 | 🌐 HTML | 📅 2026-08-10 - Can I email… Support tables for HTML and CSS in emails.
...
* [Emailens Engine](https://github.com/emailens/engine) ⭐ 11 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-29 - Lint HTML emails against 250+ CSS properties across 15 email clients: compatibility scoring, dark mode simulation, accessibility and spam checks - `MIT`, `Typescript`
...
* [Easy Email](https://github.com/zalify/easy-email) ⭐ 2,935 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-13 -  DnD Email Editor based on React.js and MJML.
...
* [emailmd](https://github.com/unmta/emailmd) ⭐ 1,331 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-26 -  Render markdown into email-safe HTML  - `MIT`, `Typescript`
...
* [Tutanota](https://github.com/tutao/tutanota) ⭐ 7,880 | 🐛 998 | 🌐 TypeScript | 📅 2026-08-28 - Tutanota is an email service with a strong focus on security and privacy that lets you encrypt emails, contacts and calendar entries on all your devices.
* [Roundcube](https://github.com/roundcube/roundcubemail) ⭐ 7,138 | 🐛 480 | 🌐 PHP | 📅 2026-08-25 -  The Roundcube Webmail suite - `GPLv3`, `PHP`
* [Cypht](https://github.com/cypht-org/cypht) ⭐ 1,701 | 🐛 139 | 🌐 PHP | 📅 2026-08-29 -  Cypht: Lightweight Open Source webmail written in PHP and JavaScript - `GNU Lesser General Public License v2.1`, `PHP`, `Javascript`
...
* [Himalaya](https://github.com/soywod/himalaya) ⭐ 7,133 | 🐛 7 | 🌐 Rust | 📅 2026-08-29 - CLI to manager email - `MIT`, `Rust`
...
* [parsedmarc](https://github.com/domainaware/parsedmarc) ⭐ 1,287 | 🐛 4 | 🌐 Python | 📅 2026-08-29 -  A Python package and CLI for parsing aggregate and forensic DMARC reports  - `Apache License version 2.0`, `Python`
...
* [DMARC Analyzer](https://github.com/dmarc-analyzer-net/DmarcAnalyzerApp) ⭐ 6 | 🐛 7 | 🌐 C# | 📅 2026-08-29 -  Self-hosted DMARC aggregate report monitoring with per-client dashboards and multi-tenant separation; also ingests MTA-STS and TLS-RPT reports  - `Apache License version 2.0`, `C#`

### Privacy

* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,954 | 🐛 256 | 🌐 Python | 📅 2026-08-25 - Protect your online identity with email alias

### Disposable emails domain list

* [disposable-email-domains](https://github.com/disposable-email-domains/disposable-email-domains) ⭐ 5,459 | 🐛 40 | 🌐 Python | 📅 2026-08-29 - a list of disposable and temporary email address domains - `Public Domain`, `Python`
* [disposable](https://github.com/disposable/disposable) ⭐ 1,438 | 🐛 65 | 🌐 Python | 📅 2026-08-09 -  A list of disposable/temporary email address domains - `MIT`, `Python`
...
* [disposable-email-domains (another one too)](https://github.com/kslr/disposable-email-domains) ⭐ 30 | 🐛 3 | 🌐 Shell | 📅 2026-08-29 -  Anti-cheating, temporary (disposable/throwaway) email list - `MIT`, `Javascript`
* [disposable-email-domains (Verifly)](https://github.com/james-sib/disposable-email-domains) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-08-29 -  Daily-refreshed master list of \~162,000 disposable/temporary email domains, plus role-account local-parts and verified dead-MX domains, in txt and JSON. - `MIT`, `Python`

## Other

* [Imapsync](https://github.com/imapsync/imapsync) ⭐ 4,137 | 🐛 192 | 🌐 Shell | 📅 2026-07-23 -  Imapsync is an IMAP transfers tool. The purpose of imapsync is to migrate IMAP accounts or to backup IMAP accounts. IMAP is one of the three current standard protocols to access mailboxes, the two others are POP3 and HTTP with webmails, webmails are often tied to an IMAP server. Upstream website is   - `No Public License`, `Shell`
